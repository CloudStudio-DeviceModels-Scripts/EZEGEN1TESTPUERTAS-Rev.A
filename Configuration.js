...
function getEndpoints(deviceAddress, endpoints)
{
 ...
 endpoints.addEndpoint("1", "Camara de Frio A", endpointType.temperatureSensor);
 endpoints.addEndpoint("2", "Horno A", endpointType.temperatureSensor);
 endpoints.addEndpoint("3", "Horno B", endpointType.temperatureSensor); 
 endpoints.addEndpoint("9", "Camara de Frio D", endpointType.temperatureSensor);
 endpoints.addEndpoint("11", "Puerta cámara de frio A", endpointType.iasSensor, iasEndpointSubType.doorSensor);
